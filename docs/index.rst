.. Blockchain Angola documentation master file, created by
   sphinx-quickstart on Fri Jan 31 18:18:40 2025.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.


.. image:: /images/blockchain_background.png
   :alt: 🚀 BlockChain Angola Banner

.. raw:: html

   <div align="center">
       <strong>
           <a href="https://www.youtube.com/playlist?list=PL3FCe9r4avxF5OAZdxIAxMeC3--3c6OwU" 
...
Blockchain Angola
=================
A full-stack Web and Mobile application for the Angolan election using Blockchain Technology behind the scenes. The system presents a user-friendly interface accessible via both mobile and web platforms.
...
Links: `Citizen (Mobile), Committee (Web) and System Administrators (Console) <https://www.youtube.com/playlist?list=PL3FCe9r4avxF5OAZdxIAxMeC3--3c6OwU>`_

.. toctree::
   :maxdepth: 2
   :caption: Contents

   sections/dev/setup_and_requirements.rst
   sections/dev/establish_network_center.rst
   sections/dev/installation_and_setup.rst
   sections/dev/backend_and_frontend.rst